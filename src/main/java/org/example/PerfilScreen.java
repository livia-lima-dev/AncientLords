...
public class PerfilScreen extends Screen {
    ...
    private void renderPerfil(
        ...
        String nivelTexto =
                "Nível: " + PlayerData.nivel;

        int nivelX =
                centerX
                        - metrics.stringWidth(nivelTexto) / 2;
        ...
        String classeTexto =
                "Classe favorita: "
                        + PlayerData.classeMaisJogada;

        int classeX =
                centerX
                        - metrics.stringWidth(classeTexto) / 2;
        ...
        int partidasX =
                centerX
                        - metrics.stringWidth(partidasTexto) / 2;
        ...
        int vitoriasX =
                centerX
                        - metrics.stringWidth(vitoriasTexto) / 2;
        ...
        int derrotasX =
                centerX
                        - metrics.stringWidth(derrotasTexto) / 2;
    ...
    private void renderSalvar(
        ...
        int salvarX =
                centerX
                        - salvarMetrics.stringWidth(salvarTexto) / 2;
        ...
        int boxWidth =
                salvarMetrics.stringWidth(salvarTexto)
                        + buttonPaddingX * 2;
    ...
    private void renderMensagemSalva(
            Graphics2D g,
            int screenWidth
    ) {
